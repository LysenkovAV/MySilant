...
# Справочник - вид технического обслуживания
...
class Machine(models.Model):
    number_machine = models.CharField(unique=True, max_length=255, verbose_name='Заводской номер машины')
...
# Содержит информацию об истории проведения технического обслуживания (ТО)
...
class Claim(models.Model):
    ...
    downtime = models.IntegerField(default=0, verbose_name='Время простоя техники')  # вычисляется в save
    machine = models.ForeignKey(Machine, on_delete=models.CASCADE, verbose_name='Машина')
    # Задается в save по машине
    service_company = models.ForeignKey(ServiceCompany, on_delete=models.CASCADE, verbose_name='Сервисная компания')
